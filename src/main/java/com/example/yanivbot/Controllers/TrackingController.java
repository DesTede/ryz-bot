                ...
                <head>
                  ...
                  <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    #header { background: #111; border-bottom: 2px solid #f5a623; padding: 10px 20px; display: flex; justify-content: center; align-items: center; height: 75px; }
